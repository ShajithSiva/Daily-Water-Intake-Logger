...
* Stores user accounts and water intake records.

### Session Management

* 🔑 **SessionManager.java** manages user login sessions.

### Utility

* 🔒 **PasswordUtils.java** is used for password hashing and security.
...
Each water record is connected to a specific user using `user_id`.
...
The application will launch and you can start tracking daily water intake.
...
5. Users can view their previous water intake records in the **History screen**
6. Each user's data is stored separately in the SQLite database
...
* 🎨 Improved UI design
* 📈 Weekly and monthly water intake charts
